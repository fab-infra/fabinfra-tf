...
dns_records = [
  ...
  { name = "es",                    ttl = 1800,  type = "CNAME",  target = "k8s" },
  { name = "gcp",                   ttl = 0,     type = "NS",     target = "ns-cloud-e1.googledomains.com." },
  { name = "gcp",                   ttl = 0,     type = "NS",     target = "ns-cloud-e2.googledomains.com." },
  { name = "gcp",                   ttl = 0,     type = "NS",     target = "ns-cloud-e3.googledomains.com." },
  { name = "gcp",                   ttl = 0,     type = "NS",     target = "ns-cloud-e4.googledomains.com." },
