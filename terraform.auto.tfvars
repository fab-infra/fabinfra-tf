...
# Kubernetes config
k8s_calico_version = "v3.30.5"
k8s_certmanager_version = "v1.19.1"
# k8s_certmanager_root_ca_crt = "toComplete"
# k8s_certmanager_root_ca_key = "toComplete"
k8s_certmanager_webhook_ovh_version = "0.9.4"
# k8s_certmanager_webhook_ovh_application_key = "toComplete"
# k8s_certmanager_webhook_ovh_application_secret = "toComplete"
# k8s_certmanager_webhook_ovh_consumer_key = "toComplete"
k8s_elastic_operator_version = "3.3.0"
k8s_ingress_nginx_version = "4.14.3"
...
dns_records = [
  ...
  { name = "",                      ttl = 600,   type = "SPF",    target = "\"v=spf1 a:ks14.srv.fabinfra.net include:mx.ovh.com include:_spf.google.com -all\"" },
  ...
  { name = "apm",                   ttl = 1800,  type = "CNAME",  target = "k8s-ingress" },
  { name = "ip",                    ttl = 3600,  type = "NS",     target = "ns-do-sg.sslip.io." },
  { name = "ip",                    ttl = 3600,  type = "NS",     target = "ns-hetzner.sslip.io." },
  { name = "ip",                    ttl = 3600,  type = "NS",     target = "ns-ovh.sslip.io." },
